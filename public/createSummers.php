...
$_SESSION['draftSummer'] = $_SESSION['draftSummer'] ?? [];
?>
...
<body>
    ...
    <h1 class="titulo">CREAR VERANO</h1>
    ...
    <div id="summerContainer" class="col-8 mx-auto d-flex flex-wrap mb-5">
        ...
        <?php
        foreach ($_SESSION['draftSummer'] as $item) {
            switch ($item['type']) {
                case 'image':
                    echo <<<HTML
    ...
    <div class="col-8 mx-auto mt-4 p-5">
        ...
        <button class="col-12 btn btn-primary fs-3" id="save-summer">Guardar Verano</button>
...
<script src="js/createSummers.js"></script>
